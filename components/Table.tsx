import { useRef, useLayoutEffect, useState, useCallback, Key } from "react";
import {
  Paper,
  TableBody,
  styled,
...
export default function InfiniteScrollTable({rows , handleTableAction , loading, updateCurrentPage }:any) {
  ...
  return (
    <TableContainer component={Paper} ref={tableEl} className="table-container">
      <Table sx={{ minWidth: 700 }} aria-label="customized table" stickyHeader>
        ...
        <TableBody>
          {rows.map((row: { title: any; url: any; created_at: any; author: any; } , i: Key | null | undefined) => {
